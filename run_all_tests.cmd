...
echo == AlpacaCore ==
cmake -S "%CORE_DIR%" -B "%CORE_DIR%build" -DALPACACORE_BUILD_TESTS=ON -DALPACACORE_ENABLE_ALL_VENDORS=%ALPACACORE_ENABLE_ALL_VENDORS% -DALPACACORE_ENABLE_WEEWX=%ALPACACORE_ENABLE_WEEWX% -DALPACACORE_REQUIRE_WEEWX=%ALPACACORE_ENABLE_WEEWX%
...
echo == AlpacaHTTP ==
cmake -S "%HTTP_DIR%" -B "%HTTP_DIR%build" -DALPACAHTTP_BUILD_TESTS=ON -DALPACAHTTP_USE_BOOST_BEAST=%ALPACAHTTP_USE_BOOST_BEAST% -DALPACACORE_ENABLE_ALL_VENDORS=%ALPACACORE_ENABLE_ALL_VENDORS% -DALPACACORE_ENABLE_WEEWX=%ALPACACORE_ENABLE_WEEWX% -DALPACACORE_REQUIRE_WEEWX=%ALPACACORE_ENABLE_WEEWX%
if errorlevel 1 exit /b 1
